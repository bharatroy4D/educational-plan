...
const Navbar = () => {
    ...
    return (
        <header>
            <div>
                <div className="container mx-auto bg-[#49BBBD] px-4 lg:px-10 py-2 flex items-center justify-between">

                    {/* Logo */}
                    <img className='w-20' src={logo} alt="logo" />

                    {/* Desktop Menu */}
                    <div className='hidden md:flex justify-center items-center text-gray-700 gap-12 font-sans'>
                        ...
                        <div className='space-x-3 font-semibold'>
                            <Link to="/login" className="bg-white text-gray-700 hover:shadow-md rounded-full px-6 py-2">Login</Link>
                            <Link to="/register" className="bg-gray-700 text-white hover:shadow-md rounded-full px-6 py-2">Register</Link>
                        </div>
                    </div>
